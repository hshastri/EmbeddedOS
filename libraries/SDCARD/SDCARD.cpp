...
unsigned char SDCARDclass::readblock(unsigned long Rstartblock, int port, char buff[])
{
...
unsigned char SDCARDclass::writeblock(unsigned long Wstartblock, int port, char buff[512])
{
unsigned char response, saveDDRB;
unsigned int i, retry=0;
